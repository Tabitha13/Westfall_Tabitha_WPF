...
var remainder = pizzaSlices * pizzaOrdered % guests; //equation to determine how many slices sparky will get
console.log ("Sparky got " + remainder + " slices of pizza."); //prints answer to console